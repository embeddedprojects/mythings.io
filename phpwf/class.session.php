...
class Session {
  ...
  function Check($appObj)
  {
    ...
    if(!$this->app->acl->CheckTimeOut() && $this->app->User->GetType()!="web"){ //TODO ACHTUNG HIER HABEN WIR ETWAS NICHT KAPIERT!!!!!
    //if(!$this->app->acl->CheckTimeOut()){ //TODO ACHTUNG HIER HABEN WIR ETWAS NICHT KAPIERT!!!!!
      $this->check = false;
