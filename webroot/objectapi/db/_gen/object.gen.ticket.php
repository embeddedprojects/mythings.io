...
$result = $result[0];
  ...
  {
    $sql = "INSERT INTO ticket (id,schluessel,zeit,projekt,bearbeiter,quelle,status,adresse,kunde,warteschlange,mailadresse,prio,betreff,zugewiesen,inbearbeitung,firma,notiz)
      VALUES('','{$this->schluessel}','{$this->zeit}','{$this->projekt}','{$this->bearbeiter}','{$this->quelle}','{$this->status}','{$this->adresse}','{$this->kunde}','{$this->warteschlange}','{$this->mailadresse}','{$this->prio}','{$this->betreff}','{$this->zugewiesen}','{$this->inbearbeitung}','{$this->firma}','{$this->notiz}')"; 
