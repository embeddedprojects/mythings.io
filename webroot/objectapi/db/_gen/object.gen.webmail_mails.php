...
$result = $result[0];
  ...
  {
    $sql = "INSERT INTO webmail_mails (id,webmail,adresse,projekt,subject,sender,plaintext,htmltext,empfang,anhang,gelesen,checksum)
      VALUES('','{$this->webmail}','{$this->adresse}','{$this->projekt}','{$this->subject}','{$this->sender}','{$this->plaintext}','{$this->htmltext}','{$this->empfang}','{$this->anhang}','{$this->gelesen}','{$this->checksum}')"; 
