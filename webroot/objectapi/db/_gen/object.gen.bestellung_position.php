...
$result = $result[0];
  ...
  {
    $sql = "INSERT INTO bestellung_position (id,bestellung,artikel,bezeichnunglieferant,bestellnummer,menge,preis,sort,status,bemerkung,logdatei)
      VALUES('','{$this->bestellung}','{$this->artikel}','{$this->bezeichnunglieferant}','{$this->bestellnummer}','{$this->menge}','{$this->preis}','{$this->sort}','{$this->status}','{$this->bemerkung}','{$this->logdatei}')"; 
