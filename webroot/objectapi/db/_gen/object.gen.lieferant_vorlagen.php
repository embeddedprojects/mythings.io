...
class ObjGenLieferant_Vorlagen
{
  ...
  public function ObjGenLieferant_Vorlagen($app)
  {
    $this->app = $app;
  }
  ...
  {
    if(is_numeric($id))
      $result = $this->app->DB->SelectArr("SELECT * FROM lieferant_vorlagen WHERE (id = '$id')");
    else
      return -1;
...
$result = $result[0];
  ...
  {
    $sql = "INSERT INTO lieferant_vorlagen (id,adresse,kundennummer,zahlungsweise,zahlungszieltage,zahlungszieltageskonto,zahlungszielskonto,versandart,logdatei)
  ...
  public function Update()
  {
    ...
    $sql = "UPDATE lieferant_vorlagen SET
  ...
  public function Delete($id="")
  {
    ...
    $sql = "DELETE FROM lieferant_vorlagen WHERE (id='{$this->id}')";
