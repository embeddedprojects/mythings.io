...
$result = $result[0];
  ...
  {
    $sql = "INSERT INTO kalender_event (id,kalender,bezeichnung,beschreibung,von,bis,public)
      VALUES('','{$this->kalender}','{$this->bezeichnung}','{$this->beschreibung}','{$this->von}','{$this->bis}','{$this->public}')"; 
