...
class WidgetAuftrag extends WidgetGenAuftrag 
{
  ...
  function ExtendsForm()
  {
    ...
    if($this->app->Secure->GetGET("action")=="edit")
    {
      ...
      $this->form->locafterexe="index.php?module=auftrag&action=artikel&id={$id}";
    }
  }
  ...
  public function Table()
  {
    ...
    $table->Query("SELECT a.datum, p.abkuerzung,if(a.typ='person',CONCAT(a.vorname,' ',a.name), a.name) as kunde, a.ort, a.email,
      a.id FROM auftrag as a, projekt as p WHERE a.projekt = p.id order by a.datum, p.abkuerzung");
