...
if(version_compare(phpversion(),'5.0.0','>=')===true)
	echo '<i>[WARNING] You currently run this script with PHP5... we advise you to use the PHP5 version of this script if you experience problems.</i>';
